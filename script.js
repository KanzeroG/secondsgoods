document.addEventListener('DOMContentLoaded', () => {
    ...
    if (checkoutButton) {
        checkoutButton.addEventListener('click', async () => {
            ...
            const paymentMethod = 'Cash on Delivery'; // Fixed payment method
            const totalAmount = document.getElementById('cart-total').innerText; // Get the total amount
            ...
            if (confirmation) {
                await sendCheckoutNotification(name, email, location, phone, cartDetails, paymentMethod);
    ...
    async function sendCheckoutNotification(name, email, location, phone, cartDetails, paymentMethod) {
        try {
    ...
    if (goodsForm) {
        goodsForm.addEventListener('submit', async (e) => {
            ...
            const itemName = document.getElementById('send-item-name').value;
